...
class TransactionGroupTransformer extends AbstractTransformer
{
    ...
    private function stringFromArray(array $array, string $key, null|string $default): null|string
    {
    ...
    private function getForeignAmount(null|string $foreignAmount): null|string
    {
    ...
    private function getForeignCurrency(null|TransactionCurrency $currency): array
    {
    ...
    private function getBudget(null|Budget $budget): array
    {
    ...
    private function getCategory(null|Category $category): array
    {
        $array = ['id'   => null, 'name' => null];
    ...
    private function getBill(null|Bill $bill): array
    {
        $array = ['id'   => null, 'name' => null];
    ...
    private function getLocation(TransactionJournal $journal): null|Location
    {
        /** @var null|Location */
