 ...
 * 
 * Generates detailed cash flow analysis reports for multiple years.
 * Shows long-term income vs expenses trends, year-over-year comparisons, and historical analysis.
 */
class MultiYearReportGenerator implements ReportGeneratorInterface
{
    ...
    /**
     * Generates the cash flow report for multiple years.
     *
    ...
    public function generate(): string
    {
        ...
        try {
            return view('reports.cashflow.multi-year', compact('accountIds', 'reportType'))
            ...
            Log::error(sprintf('Cannot render reports.cashflow.multi-year: %s', $e->getMessage()));
