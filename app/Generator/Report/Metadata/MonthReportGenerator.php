 ...
 * Useful for understanding the organizational structure of your financial data.
 * Can include semantic clustering of tags for better visualization.
 */
class MonthReportGenerator implements ReportGeneratorInterface
{
    ...
    /**
     * Generates the metadata report.
     * Shows all categories and tags with optional semantic clustering.
     *
    ...
    public function generate(): string
    {
        ...
        try {
            return view('reports.metadata.month', compact('accountIds', 'reportType'))
            ...
            Log::error(sprintf('Cannot render reports.metadata.month: %s', $e->getMessage()));
