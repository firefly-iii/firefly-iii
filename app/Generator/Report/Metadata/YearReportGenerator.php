 ...
 * Includes usage statistics over the year period.
 */
class YearReportGenerator implements ReportGeneratorInterface
{
    ...
    /**
     * Generates the metadata report for a year period.
     *
    ...
    public function generate(): string
    {
        ...
        try {
            return view('reports.metadata.year', compact('accountIds', 'reportType'))
            ...
            Log::error(sprintf('Cannot render reports.metadata.year: %s', $e->getMessage()));
