...
class RecalculatesPrimaryCurrencyAmounts
{
    ...
    private function resetTransactions(UserGroup $userGroup): void
    {
        ...
        $success = DB::table('transactions')->join('transaction_journals', 'transaction_journals.id', '=', 'transactions.transaction_journal_id')->where('transaction_journals.user_group_id', $userGroup->id)
