...
class ConfigurationRequest extends FormRequest
{
    ...
    public function getConfigurationData(): array
    {
        return [
            ...
            'exchange_rate_source'    => $this->string('exchange_rate_source'),
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'exchange_rate_source'    => sprintf('required|string|in:%s', implode(',', config('cer.allowed_sources', ['external', 'internal', 'country_national']))),
