...
class AutocompleteCategoryApiRequest extends AggregateFormRequest
{
    #[Override]
    protected function getRequests(): array
    {
        return [
            DateRequest::class,
            [PaginationRequest::class, 'sort_class' => Category::class],
            [ObjectTypeApiRequest::class, 'object_type' => Category::class],
            QueryRequest::class,
        ];
    }
}
