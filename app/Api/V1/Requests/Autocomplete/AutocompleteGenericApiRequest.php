...
class AutocompleteGenericApiRequest extends AggregateFormRequest
{
    #[Override]
    protected function getRequests(): array
    {
        return [
            // DateRequest::class,
            [PaginationRequest::class, 'sort_class' => ObjectGroup::class],
            // [ObjectTypeApiRequest::class, 'object_type' => ObjectGroup::class],
            QueryRequest::class,
        ];
    }
}
