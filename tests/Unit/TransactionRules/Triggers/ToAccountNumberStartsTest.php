...
/**
 * Class ToAccountNumberStartsTest
...
class ToAccountNumberStartsTest extends TestCase
{
    ...
    public function testTriggeredBoth(): void
    {
        ...
        $trigger = ToAccountNumberStarts::makeFromStrings('FR76', false);
    ...
    public function testTriggeredLonger(): void
    {
        ...
        $trigger = ToAccountNumberStarts::makeFromStrings('bla-bla-bla' . $account->name, false);
        $result  = $trigger->triggered($journal);
    ...
    public function testTriggeredNot(): void
    {
        ...
        $trigger = ToAccountNumberStarts::makeFromStrings('some name' . random_int(1, 234), false);
        $result  = $trigger->triggered($journal);
        $this->assertFalse($result);
    }
    ...
    public function testWillMatchEverythingEmpty(): void
    {
        $repository = $this->mock(JournalRepositoryInterface::class);
        $value      = '';
        $result     = ToAccountNumberStarts::willMatchEverything($value);
        $this->assertTrue($result);
    }
