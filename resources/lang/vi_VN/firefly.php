...
return [
    ...
    'last_thirty_days'                           => '30 ngày gần đây',
    ...
    'removed_amount'                             => 'Đã xóa :số tiền',
    'added_amount'                               => 'Đã thêm :số tiền',
    ...
    'budget_in_period'                           => 'Tất cả các giao dịch cho ngân sách ":name" giữa: bắt đầu và: kết thúc bằng: tiền tệ',
    'chart_budget_in_period'                     => 'Biểu đồ cho tất cả các giao dịch theo ngân sách ":name" giữa: bắt đầu và: kết thúc bằng: tiền tệ',
    'chart_budget_in_period_only_currency'       => 'Số tiền bạn đã lập ngân sách là: tiền tệ, vì vậy biểu đồ này sẽ chỉ hiển thị các giao dịch bằng: tiền tệ.',
    'chart_account_in_period'                    => 'Biểu đồ cho tất cả các giao dịch theo tài khoản ":name" (: số dư) giữa: bắt đầu và: kết thúc',
    ...
    'all_journals_for_account'                   => 'Tất cả các giao dịch của tài khoản: tên',
    'chart_all_journals_for_account'             => 'Biểu đồ của tất cả các giao dịch cho tài khoản: tên',
    'journals_in_period_for_account'             => 'Tất cả các giao dịch cho tài khoản: tên giữa: start và: end',
    'transferred'                                => 'Chuyển nhượng',
    'all_withdrawal'                             => 'Mọi chi phí',
    'all_transactions'                           => 'Tất cả các giao dịch',
    'title_withdrawal_between'                   => 'Tất cả các chi phí giữa: bắt đầu và: kết thúc',
    'all_deposit'                                => 'Tất cả doanh thu',
    'title_deposit_between'                      => 'Tất cả doanh thu giữa: bắt đầu và: kết thúc',
    ...
    'all_journals_for_tag'                       => 'Tất cả các giao dịch cho thẻ ":tag"',
    'title_transfer_between'                     => 'Tất cả chuyển giữa: bắt đầu và: kết thúc',
    'all_journals_for_category'                  => 'Tất cả các giao dịch cho thể loại: tên',
    'all_journals_for_budget'                    => 'Tất cả các giao dịch cho ngân sách: tên',
    'chart_all_journals_for_budget'              => 'Biểu đồ của tất cả các giao dịch cho ngân sách: tên',
    'journals_in_period_for_category'            => 'Tất cả các giao dịch cho danh mục: tên giữa: start và: end',
    ...
    'name_in_currency'                           => ':tên trong: tiền tệ',
    'paid_in_currency'                           => 'Được trả bằng: tiền tệ',
    'unpaid_in_currency'                         => 'Chưa thanh toán bằng: tiền tệ',
    ...
    'update_current_version_alert'               => 'Bạn đang chạy: , đây là phiên bản mới nhất có sẵn.',
    ...
    'search_modifier_tag'                        => 'Tag là":value"',
    'search_modifier_category'                   => 'Danh mục là ":value"',
    'search_modifier_budget'                     => 'Ngân sách là ":value"',
    'search_modifier_bill'                       => 'Hóa đơn là ":value"',
    'search_modifier_type'                       => 'Loại giao dịch là: giá trị',
    'search_modifier_date'                       => 'Ngày giao dịch là: giá trị',
    'search_modifier_date_before'                => 'Ngày giao dịch là trước: giá trị',
    'search_modifier_date_after'                 => 'Ngày giao dịch là sau: giá trị',
    'search_modifier_on'                         => 'Ngày giao dịch là: giá trị',
    'search_modifier_before'                     => 'Ngày giao dịch là trước: giá trị',
    'search_modifier_after'                      => 'Ngày giao dịch là sau: giá trị',
    ...
    'rule_trigger_tag_is'                        => 'Thẻ là ":trigger_value"',
    ...
    'rule_trigger_has_no_tag_choice'             => 'Không có thẻ',
    'rule_trigger_has_no_tag'                    => 'Giao dịch không có thẻ',
    'rule_trigger_has_any_tag_choice'            => 'Có một hoặc nhiều thẻ (bất kỳ)',
    'rule_trigger_has_any_tag'                   => 'Giao dịch có một hoặc nhiều thẻ (bất kỳ)',
    ...
    'rule_action_add_tag'                        => 'Thêm thẻ ":action_value"',
    'rule_action_remove_tag'                     => 'Xóa thẻ ":action_value"',
    'rule_action_remove_all_tags'                => 'Xóa tất cả các thẻ',
    ...
    'rule_action_add_tag_choice'                 => 'Thêm thẻ..',
    ...
    'new_rule_for_journal_description'   => 'Quy tắc này dựa trên giao dịch ":description". It will match transactions that are exactly the same.',

    // tags
    'store_new_tag'                   => 'Lưu trữ thẻ mới',
    ...
    'successful_count'                          => 'trong đó: tính thành công',
    ...
    'deleted_currency'                          => 'Tiền tệ: đã xóa',
    'created_currency'                          => 'Tiền tệ: được tạo',
    'could_not_store_currency'                  => 'Không thể lưu trữ tiền tệ mới.',
    'updated_currency'                          => 'Tiền tệ: được cập nhật',
    'ask_site_owner'                            => 'Vui lòng hỏi: chủ sở hữu để thêm, xóa hoặc chỉnh sửa tiền tệ.',
    ...
    'transactions_no_budget'                    => 'Chi phí không có ngân sách giữa: bắt đầu và: kết thúc',
    ...
    'ab_basic_modal_explain'                    => 'Sử dụng biểu mẫu này để cho biết số tiền bạn mong đợi có thể dự trù ngân sách (tổng cộng, bằng: tiền tệ) trong khoảng thời gian được chỉ định.',
    ...
    'suggested'                                 => 'Đề xuất',
    'average_between'                           => 'Trung bình giữa: bắt đầu và: kết thúc',
    ...
    'bill_expected_between'                     => 'Dự kiến giữa: bắt đầu và: kết thúc',
    ...
    'end_of_reconcile_period'                   => 'Kết thúc chu kỳ đối chiếu :: kỳ',
    'start_of_reconcile_period'                 => 'Bắt đầu chu kỳ đối chiếu :: kỳ',
    ...
    'select_at_least_one_tag'                   => 'Vui lòng chọn ít nhất một thẻ',
    ...
    'already_cleared_transactions'              => 'Đã xóa giao dịch',
    ...
    'without_category_between'                  => 'Không có danh mục giữa: bắt đầu và: kết thúc',
    ...
    'no_bulk_tags'                              => 'Đừng cập nhật thẻ',
    ...
    'spent_in_specific_tag'                     => 'Chi tiêu trong thẻ ":tag"',
    'earned_in_specific_tag'                    => 'Kiếm được trong thẻ ":tag"',
    ...
    'account_per_tag'                           => 'Tài khoản trên mỗi thẻ',
    'tag_report_expenses_listed_once'           => 'Chi phí và thu nhập không bao giờ được liệt kê hai lần. Nếu một giao dịch có nhiều thẻ, nó chỉ có thể hiển thị dưới một trong các thẻ của nó. Danh sách này có thể bị thiếu dữ liệu, nhưng số tiền sẽ chính xác.',
    'double_report_expenses_charted_once'       => 'Chi phí và thu nhập không bao giờ được hiển thị hai lần. Nếu một giao dịch có nhiều thẻ, nó chỉ có thể hiển thị dưới một trong các thẻ của nó. Biểu đồ này có thể thiếu dữ liệu, nhưng số tiền sẽ chính xác.',
    'tag_report_chart_single_tag'               => 'Biểu đồ này áp dụng cho một thẻ duy nhất. Nếu một giao dịch có nhiều thẻ, những gì bạn thấy ở đây cũng có thể được phản ánh trong biểu đồ của các thẻ khác.',
    'tag'                                       => 'Thẻ',
    ...
    'coveredWithTags'                           => 'Được bao phủ bởi các thẻ',
    ...
    'category_entry'                            => 'Chi phí và thu nhập trong danh mục ": tên" giữa: bắt đầu và: kết thúc',
    ...
    'expense_per_tag'                           => 'Chi phí cho mỗi thẻ',
    'income_per_tag'                            => 'Thu nhập trên mỗi thẻ',
    ...
    'include_income_not_in_tags'                => 'Thu nhập đã bao gồm không có trong thẻ đã chọn',
    'include_expense_not_in_tags'               => 'Bao gồm các chi phí không có trong (các) thẻ đã chọn',
    ...
    'no_tags_for_cloud'                         => 'Không có thẻ để tạo đám mây',
    'no_tags'                                   => '(không có thẻ)',
    'tag_cloud'                                 => 'Thẻ đám mây',
    ...
    'cannot_remove_from_piggy'  => 'Không thể xóa: số tiền từ ":name".',
    'deleted_piggy_bank'        => 'Xóa heo đất ":name"',
    'added_amount_to_piggy'     => 'Đã thêm: số tiền vào ":name"',
    'removed_amount_from_piggy' => 'Đã xóa: số tiền từ ":name"',
    'piggy_events'              => 'Liên quan heo đất ',

    // tags
    'delete_tag'                => 'Xóa thẻ ":tag"',
    'deleted_tag'               => 'Đã xóa thẻ ":tag"',
    'new_tag'                   => 'Tạo thẻ mới',
    'edit_tag'                  => 'Chỉnh sửa thẻ ":tag"',
    'updated_tag'               => 'Đã cập nhật thẻ ":tag"',
    'created_tag'               => 'Thẻ ":tag" đã được tạo!',
    ...
    'split-transactions'                    => 'Giao dịch phân chia',
    'do_split'                              => 'Làm một tách',
    'split_this_withdrawal'                 => 'Chia tiền này',
    'split_this_deposit'                    => 'Chia tiền gửi này',
    'split_this_transfer'                   => 'Tách chuyển khoản này',
    ...
    'no_tags_title_default'                 => 'Hãy tạo một thẻ!',
    'no_tags_intro_default'                 => 'Bạn chưa có thẻ nào. Các thẻ được sử dụng để tinh chỉnh các giao dịch của bạn và gắn nhãn chúng với các từ khóa cụ thể.',
    'no_tags_imperative_default'            => 'Thẻ được tạo tự động khi bạn tạo giao dịch, nhưng bạn cũng có thể tạo một giao dịch theo cách thủ công. Hãy tạo ngay bây giờ:',
    'no_tags_create_default'                => 'Tạo một thẻ',
    ...
    'recurring_meta_field_tags'          => 'Thẻ',
    'recurring_meta_field_notes'         => 'Ghi chú',
    'recurring_meta_field_bill_id'       => 'Hóa đơn',
    'recurring_meta_field_piggy_bank_id' => 'Heo đất',
    ...
    'box_sum_in_currency'                => 'Tổng (: tiền tệ)',
    ...
    'box_spend_per_day'                  => 'Còn lại để chi tiêu mỗi ngày :: số tiền',
