...
return [
    ...
    'pref_national_rates_country_title'                   => 'National bank exchange rates',
    'pref_national_rates_country_help'                    => 'Fallback for installs where this administration does not have a country bound on its edit page. Pick the country whose rates you want to use, or leave empty to opt out. Administration-level setting always wins when set.',
    'pref_national_rates_country_label'                   => 'Country',
    'pref_national_rates_country_none'                    => '— none —',
    ...
    'administration_country_form_help'                    => 'When the global exchange-rate source is set to "country_national", Firefly III will fetch daily rates from this country’s central bank for every member of this administration. Only countries with a registered provider are listed.',
    'administration_country_none'                         => '— none —',
    ...
    'setting_exchange_rate_source'                        => 'Exchange rate source',
    'setting_exchange_rate_source_explain'                => 'Choose where Firefly III gets exchange rates from when exchange rates are enabled. Option values: external, internal, country_national.',
    'setting_exchange_rate_source_external'               => 'Firefly III external service (external)',
    'setting_exchange_rate_source_internal'               => 'Built-in fallback rates (internal)',
    'setting_exchange_rate_source_country_national'       => 'National provider by country (country_national, future)',
