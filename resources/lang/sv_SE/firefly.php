...
return [
    ...
    'convert_explanation_withdrawal_deposit'    => 'Om du konverterar detta uttag till en insättning kommer :amount att deponeras i <a href=":sourceRoute">:sourceName</a> istället för att tas från det.',
    'convert_explanation_withdrawal_transfer'   => 'Konvertering av detta uttag till en överföring, :amount överförs från <a href=":sourceRoute">:sourceName</a> till ett nytt tillgångskonto, istället för betalas mot <a href=":destinationRoute">:destinationName</a>.',
    ...
    'convert_explanation_deposit_transfer'      => 'Konverting från insättning till överföring, :amount kommer att föras över från ett tillgångskonto av ditt val till <a href=":destinationRoute">:destinationName</a>.',
    'convert_explanation_transfer_withdrawal'   => 'Konvertering från överföring till uttag, :amount flyttas från <a href=":sourceRoute">:sourceName</a> tll ett nytt destination som utgift istället för till <a href=":destinationRoute">:destinationName</a> som en överföring.',
