...
return [
    ...
    'source_equals_destination'      => 'Kaynak hesap, hedef hesaba eşittir',
    'unique_account_number_for_user' => 'Bu hesap numarası zaten kullanılmaktadır.',
    'unique_iban_for_user'           => 'Bu IBAN zaten kullanımdadır.',
    ...
    'all_accounts_equal'             => 'Bu alandaki tüm hesaplar eşit olmalıdır.',
    'invalid_selection'              => 'Seçiminiz geçersiz',
    'belongs_user'                   => 'Bu değer bu alan için geçersiz.',
    'at_least_one_transaction'       => 'En az bir işlem gerekiyor.',
    'require_currency_info'          => 'Bu alanın içeriği para birimi bilgisi olmadan geçersiz.',
    'equal_description'              => 'İşlem açıklaması, genel açıklamaya eşit olmamalıdır.',
    ...
    'amount_min_over_max'            => 'Minimum tutar, maksimum tutardan daha büyük olamaz.',
    ...
    'unique_piggy_bank_for_user'     => 'Kumbara ismi benzersiz olmalı.',
    'secure_password'                => 'Bu güvenli bir şifre değildir. Lütfen tekrar deneyin. Daha fazla bilgi için ziyaret edin = http://bit.ly/FF3-password-security',
    'attributes'                     => [
        'email'                   => 'eposta',
        ...
        'title'                   => 'başlık',
        'tag'                     => 'etiket',
        'transaction_description' => 'transfer açıklaması',
