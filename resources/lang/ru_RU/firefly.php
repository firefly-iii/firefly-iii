 ...
 */
    ...
    'search_modifier_not_has_no_bill'                     => 'Транзакция должна иметь (любой) счёт к оплате',
    ...
    'search_modifier_not_bill_starts'                     => 'Счет не начинается с ":value"',
    ...
    'search_modifier_book_date_on_day'                    => 'Дата начисления процентов приходится на день месяца ":value"',
 ...
 */
    ...
    'rule_trigger_has_any_bill'                           => 'У транзакции есть (любой) счет на оплату',
    ...
    'rule_trigger_any_external_url_choice'                => 'У транзакции есть (любой) внешний URL',
    'rule_trigger_any_external_id'                        => 'У транзакции есть (любой) внешний идентификатор',
    'rule_trigger_any_external_id_choice'                 => 'У транзакции есть (любой) внешний идентификатор',
    ...
    'rule_trigger_no_external_id_choice'                  => 'У транзакции нет внешнего идентификатора',
    ...
    'rule_trigger_not_has_no_bill'                        => 'У транзакции есть (любой) счет на оплату',
 ...
 */
    ...
    'rule_action_set_amount'                              => 'Установить сумму в ":action_value"',
    ...
    'rule_for_bill_title'                                 => 'Автоматически сгенерированное правило для счета ":name"',
    'rule_for_bill_description'                           => 'Это правило автоматически сгенерировано для того, чтобы попробовать соответствовать счету ":name".',
 ...
 */
    ...
    'admin_notification_check_user_new_reg'               => 'Пользователь получает приветственное сообщение после регистрации',
    'admin_notification_check_admin_new_reg'              => 'Администраторы(ы) получают уведомление о регистрации нового пользователя',
    'admin_notification_check_new_version'                => 'Доступна новая версия',
    'admin_notification_check_invite_created'             => 'Пользователь приглашен на Firefly III',
    'admin_notification_check_invite_redeemed'            => 'Приглашение пользователя использовано',
