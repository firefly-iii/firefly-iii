...
return [
    ...
    'recurring-index'        => 'Пожалуйста, обратите внимание, что эта функция находится в активной разработке и может работать не совcем так, как вы ожидаете.',
    'recurring-create'       => 'Пожалуйста, обратите внимание, что эта функция находится в активной разработке и может работать не совcем так, как вы ожидаете.',
];
