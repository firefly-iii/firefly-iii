...
return [
    ...
    'advanced_search_intro'                      => 'Es gibt mehrere Modifikatoren die du benutzen kannst um die Suchergebnisse einzugrenzen. Wenn du diese benutzt, dann wir die Suche <em>nur</em> Transaktionen enthalten. Bitte klicke auf das <i class="fa fa-question-circle"></i>-Icon für mehr Informationen.',
    ...
    'transaction_journal_other_options'          => 'Andere Optionen',
    'multi_select_no_selection'                  => 'Keine ausgewählt',
...
Sollen zusätzlich Ihre Girokonten angezeigt werden?',
    ...
    'convert_Withdrawal_to_transfer'             => 'Konvertieren Sie eine Ausgabe zu einer Überweisung',
    ...
    'cannot_edit_other_fields'                   => 'Keine Massenbearbeitung von anderen Feldern außer den hier zu sehenden möglich, da nicht genügend Platz vorhanden ist um diese anzuzeigen. Bitte folge dem Link und editiere diese nacheinander wenn du diese Felder editieren willst.',
    ...
    // reports:
    'report_default'                             => 'Standard Finanzbericht zwischen :start und :end',
    'report_audit'                               => 'Transaktionshistorie Übersicht zwischen :start und :end',
    'report_category'                            => 'Kategorie Bericht zwischen :start und :end',
    'report_budget'                              => 'Budget Bericht zwischen :start und :end',
    ...
    'reportsOwnAccountsAndShared'                => 'Berichte für deine eigenen Konten und geteilten Konten',
    ...
    'leftUnbalanced'                             => 'Noch unausgeglichen',
    ...
    'income_entry'                               => 'Einkommen von Konto ":name" zwischen :start und :end',
    'expense_entry'                              => 'Ausgaben von Konto ":name" zwischen :start und :end',
    'category_entry'                             => 'Ausgaben in Kategorie ":name" zwischen :start und :end',
    'budget_spent_amount'                        => 'Ausgaben in Budget ":budget" zwischen :start und :end',
    'balance_amount'                             => 'Ausgaben in Budget ":budget" bezahlt vom Konto ":account" zwischen :start und :end',
    'no_audit_activity'                          => 'Keine Aktivität aufgezeichnet im Konto <a href=":url" title=":account_name">:account_name</a> zwischen :start und :end.',
    ...
    'account_role_defaultAsset'                  => 'Standard Konto',
    'account_role_sharedAsset'                   => 'Geteiltes Konto',
    ...
    'balancing_act'              => 'Dieser Tag aktzeptiert höchstens zwei Transaktionen; Eine Ausgabe und eine Überweisung. Diese gleichen sich gegenseitig aus.',
    'advance_payment'            => 'Dieser Tag aktzeptiert eine Ausgabe und eine beliebige Anzahl an Einzahlungen mit dem Ziel dass diese die ursprüngliche Ausgabe ausgleichen.',
    ...
    'tags_start'                 => 'Erstelle einen Tag um zu starten oder gib neue Tags ein wenn du eine Transaktion erstellst.',
    ...
    'setting_send_email_explain'           => 'Firefly III kann E-Mail-Benachrichtigungen bei bestimmten Ereignissen senden. Diese werden an <code>:site_owner</code> gesendet. Diese Email Adresse kann in der <code>.env</code> Datei geändert werden.',
    'block_code_bounced'                   => 'Email Nachricht(en) unzustellbar',
    ...
    'import_status_import_running'         => 'Der Import läuft gerade noch. Bitte noch etwas Geduld.',
    ...
    'import_error_fatal'                   => 'Es gab einen Fehler während des Import Vorgangs. Bitte überprüfen Sie die Logdateien. Der Error scheint folgender zu sein:',
    ...
    'import_finished_all'                  => 'Der Import wurde fertiggestellt. Bitte überprüfen Sie das Ergebniss unten.',
    'import_with_key'                      => 'Importieren mit Schlüssel \':key\'',
    ...
    'bread_crumb_import_complete'          => 'Import ":key" fertiggestellt',
    'bread_crumb_configure_import'         => 'Konfiguriere Import ":key"',
    'bread_crumb_import_finished'          => 'Import ":key" fertiggestellt',
    'import_finished_intro'                => 'Der Import wurde fertiggestellt. Die neuen Transaktionen können nun in Firefly angesehn werden',
    ...
    'sandstorm_not_available'              => 'Diese Funktion ist nicht verfügbar wenn Firefly III innerhalb einer Sandstorm.io Umgebung ausgeführt wird.',
];