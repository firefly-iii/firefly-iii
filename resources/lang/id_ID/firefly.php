...
return [
    ...
    'convert_explanation_withdrawal_deposit'   => 'Jika Anda mengubah penarikan ini menjadi deposit ,: jumlah akan disetorkan ke <a href=":sourceRoute"> : sourceName </a> alih-alih diambil darinya.',
    'convert_explanation_withdrawal_transfer'  => 'Jika Anda mengubah penarikan ini menjadi transfer ,: jumlah akan ditransfer dari <a href=":sourceRoute"> : sourceName </a> ke akun aset baru, alih-alih dibayar ke <a href=":destinationRoute"> : destinationName </a>.',
    'convert_explanation_deposit_withdrawal'   => 'Jika Anda mengonversi setoran ini menjadi penarikan ,: jumlah akan dihapus dari <a href=":destinationRoute"> : destinationName </a> alih-alih ditambahkan ke penarikan tersebut.',
    'convert_explanation_deposit_transfer'     => 'Jika Anda mengonversi setoran ini menjadi transfer ,: jumlah akan ditransfer dari akun aset pilihan Anda ke <a href=":destinationRoute"> : destinationName </a> .',
    'convert_explanation_transfer_withdrawal'  => 'Jika Anda mengubah transfer ini menjadi penarikan ,: jumlah akan beralih dari <a href=":sourceRoute"> : sourceName </a> ke tujuan baru sebagai biaya, alih-alih <a href=":destinationRoute"> : destinationName </a> sebagai transfer.',
    'convert_explanation_transfer_deposit'     => 'Jika Anda mengubah transfer ini menjadi deposit ,: jumlah akan disetorkan ke akun <a href=":destinationRoute"> : destinationName </a> alih-alih ditransfer ke sana.',
    ...
    'audit_end_balance'                        => 'Saldo akun <a href=":url" title=":account_name"> :account_name</a> di akhir: akhir adalah:: keseimbangan',
