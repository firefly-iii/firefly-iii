...
return [
    ...
    'secure_pw_hash_security'                 => 'Questa collisione non sarebbe uguale alla tua password, né sarebbe utile su (un sito come) Firefly III. Questa applicazione non utilizza SHA1 per la verifica della password. Quindi è sicuro selezionare questa casella. La tua password viene sottoposta a hash e solo i primi cinque caratteri di questo hash vengono inviati tramite HTTPS.',
