...
return [
    ...
    'search_modifier_source_account_nr_ends'          => 'Lähdetilin numero (IBAN) päättyy ":value"',
    ...
    'search_modifier_destination_account_ends'        => 'Kohdetilin nimi päättyy ":value"',
    'search_modifier_destination_account_id'          => 'Kohdetilin tunnus on :value',
    'search_modifier_destination_is_cash'             => 'Kohdetili on (käteis) tili',
    'search_modifier_source_is_cash'                  => 'Lähdetili on (käteis) tili',
    ...
    'rule_action_update_piggy'                            => 'Lisää/poista tapahtuman summa säästöpossussa ":action_value"',
