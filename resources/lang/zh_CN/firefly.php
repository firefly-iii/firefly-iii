 ...
 */
    ...
    'rule_trigger_any_external_url_choice'                => '交易有一个（任意）外部链接',
    'rule_trigger_any_external_id'                        => '交易有一个（任意）外部ID',
    'rule_trigger_any_external_id_choice'                 => '交易有一个（任意）外部ID',
    'rule_trigger_no_external_url_choice'                 => '交易没有外部链接',
    'rule_trigger_no_external_url'                        => '交易没有外部URL',
    'rule_trigger_no_external_id_choice'                  => '交易没有外部ID',
    ...
    'rule_trigger_not_has_no_bill'                        => '交易有 (任何) 一个账单',
 ...
 */
    ...
    'rule_for_bill_description'                           => '此规则是自动生成的，尝试匹配账单“:name”。',
...
',
    ...
    'pref_notification_rule_action_failures'    => '当规则操作失败时发出警告 (仅适用于Slack或者Discord)',
 ...
 */
    ...
    'not_or_not_yet'                            => '尚未',
    'visit_bill'                                => '在Firefly III中访问名为“:name”的账单',
    'match_between_amounts'                     => '匹配:low至:high交易的账单。',
    'running_again_loss'                        => '如果与此账单已关联的交易 (不再) 与规则相符，其间的关联可能会丢失。',
    'bill_related_rules'                        => '与此账单相关的规则',
    'repeats'                                   => '重复',
    'bill_end_date_help'                        => '可选字段，此账单延续至此日期结束。',
    'bill_extension_date_help'                  => '可选字段，此账单必须在此日期或之前延续 (或取消)。',
 ...
 */
    ...
    'invite_new_user_text'                     => '作为管理者，您可以邀请用户注册您的Firefly III，他们可以通过您分享的直链注册一个账户。被邀请的用户和邀请链接显示在下表中，您可以自由分享邀请链接。',
