...
return [
    ...
    'two_factor_lost_intro'                      => '不幸地，这并非您可以从网页介面重新设置的，您有两个选择。',
    'two_factor_lost_fix_self'                   => '若您自行营运 Firefly III 伺服器，请检察 <code>storage/logs</code> 内的日志以供指引。',
    ...
    'title_transfer_between'                     => '自 :start 至 :end 的所有转帐',
    ...
    'export_data'                                => '汇出资料',
    'export_and_backup_data'                     => '汇出资料',
    'export_data_intro'                          => '使用汇出资料转移至新的财务应用程式。请注意这些档案并非备份，它们未包含足够的后设资料以供新安装的 Firefly III 作为完全还原所用。如果您希望备份您的资料，请直接备份整个资料库。',
    'export_format'                              => '汇出格式',
    'export_format_csv'                          => '以逗号分隔的数值 (CSV档案)',
    ...
    'export_status_make_exporter'                => '建立汇出相关物件…',
    ...
    '2fa_use_secret_instead'                  => '如果您无法扫描 QR 码，请使用密钥: :secret。',
    ...
    'mass_bulk_journals_explain'              => '使用大量编辑功能时，若您不想一步一步变更您的交易，您可一次性地进行更新。只要在下方的栏位选择想要的分类、标签或预算，所有表格内的交易都会被更新。',
    ...
    'perm-delete-many'                        => '一次删除多个项目系非常危险的，请审慎考虑。',
    ...
    'store_piggy_bank'                        => '储存新的小猪存钱罐',
    'stored_piggy_bank'                       => '储存新的小猪存钱罐 “:name”',
    'account_status'                          => '帐户状态',
    ...
    'transaction'                           => '交易',
    'comments'                              => '评论',
    'to_link_not_found'                     => '若您想要链结的交易不在清单上，只需要输入它的 ID 即可。',
    ...
    'cannot_edit_reconciled'                => '你不能这样编辑#:id交易，因为:description已经被用来关联',
    'cannot_edit_opening_balance'           => '您无法编辑一个帐户的开户余额。',
    'no_edit_multiple_left'                 => '您没有选择有效的交易纪录以供编辑。',
    'cannot_convert_split_journal'          => '无法转换拆分交易记录',
    ...
    'no_piggies_intro_default'              => '您目前没有小猪存钱罐。您可以建立小猪存钱罐来分别您的储蓄，并追踪您储蓄的目标。',
