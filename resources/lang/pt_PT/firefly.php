...
return [
    ...
    'no_bill_pointer'                      => 'Parece que ainda não tem Despesas. Pode criá-las na página de <a href="bills">despesas</a>. As Despesas podem ajudá-lo a controlar os gastos.',
    ...
    'all_withdrawal'                       => 'Todos os gastos',
    'all_transactions'                     => 'Todas as transações',
    'title_withdrawal_between'             => 'Todos os gastos entre :start e :end',
    ...
    'active_bills_only'                    => 'apenas despesas ativas',
    'active_bills_only_total'              => 'todas as despesas ativas',
    'active_exp_bills_only'                => 'apenas faturas ativas e esperadas',
    'active_exp_bills_only_total'          => 'todas as despesas esperadas ativas',
    ...
    'average_per_bill'                     => 'média por despesa',
 ...
 */
    ...
    'search_modifier_not_account_id'                      => 'As ID\'s das contas de origem ou destino não são: :value',
    ...
    'search_modifier_not_bill_is'                         => 'A fatura não é ":value"',
    ...
    'search_modifier_not_bill_contains'                   => 'A fatura não contém ":value"',
 ...
 */
    ...
    'rule_trigger_any_external_url'                       => 'A transação tem um URL externo',
    'rule_trigger_any_external_url_choice'                => 'A transação tem um URL externo',
    'rule_trigger_no_external_url_choice'                 => 'A transação não tem um URL externo',
    ...
    'rule_trigger_account_is_choice'                      => 'Qualquer das contas é exatamente..',
    'rule_trigger_account_is'                             => 'Qualquer das contas é exatamente ":trigger_value"',
    'rule_trigger_account_contains_choice'                => 'Qualquer das contas contém..',
    'rule_trigger_account_contains'                       => 'Qualquer das contas contém ":trigger_value"',
    ...
    'rule_trigger_bill_contains'                          => 'A fatura contém ":trigger_value"',
    'rule_trigger_bill_ends_choice'                       => 'A fatura termina com..',
    'rule_trigger_bill_ends'                              => 'A fatura termina com ":trigger_value"',
    'rule_trigger_bill_starts_choice'                     => 'A fatura começa com..',
    'rule_trigger_bill_starts'                            => 'A fatura começa com ":trigger_value"',
    ...
    'rule_trigger_internal_reference_ends'                => 'Uma referência interna termina com ":trigger_value"',
    'rule_trigger_internal_reference_starts_choice'       => 'Uma referência interna começa com..',
    'rule_trigger_internal_reference_starts'              => 'Uma referência interna começa com ":trigger_value"',
    ...
    'rule_trigger_not_bill_is'                            => 'A fatura não é ":trigger_value"',
    'rule_trigger_not_bill_contains'                      => 'A fatura não contém ":trigger_value"',
    'rule_trigger_not_bill_ends'                          => 'A fatura não termina em ":trigger_value"',
    'rule_trigger_not_bill_starts'                        => 'A despesa não termina com ":trigger_value"',
    ...
    'rule_trigger_not_has_any_bill'                       => 'A transação não tem despesa',
    ...
    'rule_trigger_not_has_no_bill'                        => 'A transação tem uma despesa (qualquer)',
    'rule_trigger_not_has_no_tag'                         => 'A transação tem uma etiqueta (qualquer)',
 ...
 */
    ...
    'rule_action_link_to_bill_choice'                     => 'Ligar a despesa..',
    ...
    'rulegroup_for_bills_description'                     => 'Um grupo especial de regras para todas as regras que envolvem despesas.',
    'rule_for_bill_title'                                 => 'Regra gerada automaticamente para a despesa ":name"',
    'rule_for_bill_description'                           => 'Esta regra é gerada automaticamente para tentar corresponder à despesa ":name".',
    'create_rule_for_bill'                                => 'Criar uma nova regra para a fatura ":name"',
    'create_rule_for_bill_txt'                            => 'Acabou de criar uma despesa de nome ":name", parabéns! O Firefly III pode, automagicamente, fazer corresponder novos levantamentos a esta despesa. Por exemplo, sempre que pagar a sua renda, a despesa "renda" será ligada a esse custo. Desta forma, o Firefly III pode, de forma precisa, mostrar-lhe que despesas estão vencidas e quais não estão. Para poder fazê-lo, deve criar uma regra. O Firefly III preencheu por si alguns campos com informação padrão. Por favor, certifique-se que estão certos. Se os valores estiverem corretos, o Firefly III irá, automaticamente, ligar o levantamento certo à despesa certa. Por favor, verifique os gatilhos para ver se estão certos e ajuste o que for necessário se estiverem errados.',
    ...
    'pref_YTD'                                  => 'Desde o início do ano',
    'pref_QTD'                                  => 'Desde o início do trimestre',
    'pref_MTD'                                  => 'Desde o início do mês',
    ...
    'pref_notification_bill_reminder'           => 'Lembrete sobre despesas a expirar',
 ...
 */
    ...
    'auto_budget_adjusted_icon'                 => 'O montante orçamentado aumentará periodicamente e será corrigido para gastos excessivos',
    ...
    'visit_bill'                                => 'Visite a despesa ":name" no Firefly III',
    ...
    'repeats'                                   => 'Repete',
    'bill_end_date_help'                        => 'Campo opcional. É esperado que a despesa cesse nesta data.',
    'bill_extension_date_help'                  => 'Campo opcional. A despesa deve ser prorrogada (ou cancelada) até esta data.',
    'bill_end_index_line'                       => 'Esta fatura termina em :date',
    'bill_extension_index_line'                 => 'Esta despesa deve ser prorrogada ou cancelada em :date',
 ...
 */
    ...
    'user_is_invited'                          => 'O endereço de email ":address" foi convidado para o Firefly III',
    ...
    'admin_notification_check_invite_redeemed' => 'Um convite de utilizador foi resgatado',
    ...
    'no_new_transaction_in_recurrence'      => 'Nenhuma transação nova foi criada. Talvez já tenha sido acionada nesta data?',
 ...
 */
    ...
    'ale_action_set_bill'                => 'Ligado a despesa',
