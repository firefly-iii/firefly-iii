...
return [
    ...
    'pref_languages_locale'                      => 'Pour une langue autre que l’anglais et pour fonctionner correctement, votre système d’exploitation doit être équipé avec les paramètres régionaux correspondant à la langue sélectionnée. S\'ils ne sont pas présents, les données de devises, les dates et les montants peuvent être mal formatés.',
    ...
    'pref_optional_fields_transaction_help'    => 'Par défaut, tous les champs ne sont pas activés lors de la création d\'une nouvelle transaction (en raison de possibles problèmes d'affichage sur de petits écrans). Ci-dessous, vous pouvez activer ces champs si vous pensez qu\'ils pourraient vous être utiles. Bien sûr, tout domaine désactivé, mais déjà rempli, sera visible quel que soit le paramètre.',
    ...
    'secure_pw_check_box'                      => 'En cochant la case, Firefly III enverra l\'empreinte SHA1 de votre mot de passe au <a href="https://www.troyhunt.com/introducing-306-million-freely-downloadable-pwned-passwords/">site web de Troy Hunt</a> pour voir s\'il est sur la liste. Cela vous évitera d\'utiliser des mots de passe dangereux comme cela est recommandé dans les dernières <a href="https://pages.nist.gov/800-63-3/sp800-63b.html">NIST Special Publication</a> à ce sujet.',
    ...
    'explain_access_token'                     => 'Vous avez besoin de ce token pour exécuter des opérations optionnelles en ligne de commandes telles que l\'import et export de données. Sans celui-ci, ces commandes sensibles ne fonctionneront pas. Personne ne vous le demandera, pas même moi. Si vous craignez de le perdre, ou si vous êtes parano, régénérez ce token à l\'aide du bouton.',
    ...
    'bill_expected_between'                    => 'Attendu entre :start et :end',
    ...
    'Default account'                          => 'Compte Principal',
    ...
    'no_tags_imperative_default'            => 'Les tags sont créés automatiquement lorsque vous créez des transactions, mais vous pouvez créer manuellement. Nous allons en créer un maintenant :',
