 ...
 */
    ...
    'search_modifier_account_ends'                        => '두 계정 모두 ":value"로 끝납니다',
    'search_modifier_not_account_ends'                    => '두 계정 모두 ":value"로 끝나지 않습니다',
    'search_modifier_account_starts'                      => '두 계정 모두 ":value"로 시작합니다',
    'search_modifier_not_account_starts'                  => '두 계정 모두 ":value"로 시작하지 않습니다',
    'search_modifier_account_nr_is'                       => '두 계정의 번호 / IBAN은 모두 ":value"입니다',
    'search_modifier_not_account_nr_is'                   => '두 계정의 번호 / IBAN은 모두 ":value"가 아닙니다',
    'search_modifier_account_nr_contains'                 => '두 계정의 번호 / IBAN은 모두 ":value"를 포함합니다',
    'search_modifier_not_account_nr_contains'             => '두 계정의 번호 / IBAN은 모두 ":value"를 포함하지 않습니다',
    'search_modifier_account_nr_ends'                     => '두 계정의 번호 / IBAN은 모두 ":value"로 끝납니다',
    'search_modifier_not_account_nr_ends'                 => '두 계정의 번호 / IBAN은 모두 ":value"로 끝나지 않습니다',
    'search_modifier_account_nr_starts'                   => '두 계정의 번호 / IBAN은 모두 ":value"로 시작합니다',
 ...
 */
    ...
    'rule_trigger_account_id_choice'                      => '둘 중 하나의 계정 ID는 정확히..',
    'rule_trigger_account_id'                             => '계정 ID가 정확히 :trigger_value와 일치합니다.',
    ...
    'rule_trigger_account_is_cash_choice'                 => '두 계정 모두 현금입니다',
    'rule_trigger_account_is_cash'                        => '두 계정 모두 현금입니다',
    ...
    'rule_trigger_account_is_choice'                      => '각 계정은 정확히..',
    'rule_trigger_account_is'                             => '각 계정은 정확히 ":trigger_value"입니다',
    'rule_trigger_account_contains_choice'                => '각 계정은 다음을 포함함..',
    'rule_trigger_account_contains'                       => '각 계정은 ":trigger_value"를 포함합니다.',
    'rule_trigger_account_ends_choice'                    => '각 계정은 다음으로 끝납니다.',
    'rule_trigger_account_ends'                           => '각 계정은 ":trigger_value"로 끝납니다',
    'rule_trigger_account_starts_choice'                  => '각 계정은 다음으로 시작합니다..',
    'rule_trigger_account_starts'                         => '각 계정은 ":trigger_value"로 시작합니다',
    'rule_trigger_account_nr_is_choice'                   => '각 계정 번호 / IBAN은..',
