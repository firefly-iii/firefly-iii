...
return [
    ...
    'clone_instructions'                         => 'Als u een transactie wilt klonen, zoekt u naar het selectievakje 'opslaan als nieuw' in het bewerkingsscherm',
    ...
    'change_your_email'                         => 'Verander je e-mailadres',
    'email_verification'                        => 'Het systeem verstuurt een mailtje naar je oude EN nieuwe e-mailadres. Uit veiligheidsoverwegingen ben je zo meteen uitgelogd en kan je pas weer inloggen als je je e-mailadres hebt bevestigd. Doe dit niet als je niet zeker weet of je Firefly III installatie wel mail kan versturen. Als je een admin bent, test dit dan eerst in de <a href="/admin">administratie</a>.',
    'email_changed_logout'                      => 'Je kan niet inloggen tot je je e-mailadres bevestigd.',
    'login_with_new_email'                      => 'Je kan nu inloggen met je nieuwe e-mailadres.',
    'login_with_old_email'                      => 'Je kan nu weer inloggen met je oude e-mailadres.',
    ...
    // attachments
    'nr_of_attachments'                         => 'Een bijlage|:count bijlagen',
    ...
    'disable_EUR_side_effects'                  => 'De euro is de standaardvaluta van Firefly III. Als je die uitzet kan het zijn dat je dingen sloopt. Doe dit op eigen risico.',
    ...
    'over_budget_warn'                          => '<i class="fa fa-money"></i> Normaal gesproken budgetteer je :amount per dag. Nu sta je op :over_amount per dag. Zeker weten?',
    ...
    'overview_of_reconcile_modal'               => 'Overzicht van afstemming',
    ...
    'opt_group_cashWalletAsset'                 => 'Cash portemonnees',
    ...
    'finish_up_new_user'                        => 'Dat was het! Druk op <strong>Opslaan</strong> om door te gaan. Je gaat dan naar de homepage van Firefly III.',
    ...
    'quick_link_examples'                       => 'Dit zijn wat voorbeelden om mee te beginnen. Check de help-pagina\'s onder de (?)-knop voor meer info over de overzichten en de "magic words" die je kan gebruiken.',
    ...
    'report_type_default'                       => 'Standaard financieel rapport',
    ...
    'block_code_email_changed'         => 'De gebruiker heeft zijn nieuwe e-mailadres nog niet bevestigd',
    ...
    'no_recurring_imperative_default'       => 'Dit is een behoorlijk geavanceerde functie maar het kan vreselijk handig zijn. Lees ook zeker de documentatie (?)-icoontje rechtsboven) voor je verder gaat.',
