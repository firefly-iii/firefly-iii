...
return [
    ...
    'create_new_transaction'                              => 'Създай нова транзакция',
    ...
    'field_supports_markdown'                             => 'Това поле подържа <a href="https://en.support.wordpress.com/markdown-quick-reference/">Markdown</a>.',
    ...
    'cannot_redirect_to_account'                          => 'Firefly III не може да ви пренасочи към правиланта страница. Извиняваме се.',
    ...
    'chart_account_in_period'                             => 'Графика на всички тразакции за сметка ":name" (:balance) между :start и :end',
    'chart_category_in_period'                            => 'Графика на всички тразакции за категория ":name" между :start и :end',
    ...
    'transaction_data'                                    => 'Данни на тразакцията',
    ...
    'admin_update_check_title'                            => 'Aвтоматично проверявай за обновяване',
    ...
    'rule_help_strict'                                    => 'В строги правила ВСИЧКИ задействания трябва да се случат, за да се изпълни действието. В не строги правила, НЯКОЕ задействание е достатъчно за изпълнението на действията.',
    ...
    'rule_trigger_category_is'                            => 'Категирията е ":trigger_value"',
    ...
    'rule_action_remove_tag_choice'                       => 'Премахи етикета..',
    ...
    'apply_rule_warning'              => 'Предупреждение: Изпълнението на правило (група) за голям набор от транзакции може да отнеме цяла вечност и да изтече времето на връзката. Ако това стане, правилото (групата) ще се приложи само към неизвестен брой от вашите транзакции. Това може да остави финансовoто ви управление "разпокъсано". Моля, бъдете внимателни.',
    ...
    'new_rule_for_journal_description'          => 'Това правило е базирано на тразакция ":description". То ще открива транзакции, които са идентични.',
    ...
    'delete_all_categories'                     => 'Изтриите ВСИЧКИ ваши категории',
    ...
    'delete_all_liabilities'                    => 'Изтриите ВСИЧКИ ваши задължения',
    ...
    'secure_pw_history'                         => 'Не минава и седмицабез да прочетете в новините за сайт, който губи паролите на своите потребители. Хакерите и крадците използват тези пароли, за да се опитат да откраднат вашата лична информация. Тази информация е ценна.',
    ...
    'secure_pw_should'                          => 'Трябва ли да маркирам квадрадчето?',
    ...
    'suggested'                                 => 'Предложен',
    'average_between'                           => 'Средно меджу :start и :end',
    ...
    'repeats'                                   => 'Повторения',
    'connected_journals'                        => 'Свързани трансакции',
    ...
    'reconciliation'                            => 'Съгласуване',
    'reconcile_options'                         => 'Настойки за съгласуване',
    ...
    'credit_card_options'                       => 'Настойки за кредитни карти',
    ...
    'tag_report_expenses_listed_once'           => 'Разходите и доходите никога не са посочени два пъти. Ако транзакцията има множество етиети, тя може да се показва само под един от нейните етикети. В този списък може да изглежда че липсват данни, но сумите ще бъдат правилни.',
    'double_report_expenses_charted_once'       => 'Разходите и доходите никога не са посочени два пъти. Ако транзакцията има множество етиети, тя може да се показва само под един от нейните етикети. В тази графика може да изглежда че липсват данни, но сумите ще бъдат правилни.',
    ...
    'debt_start_amount'                         => 'Налачна сума на дълга',
    ...
    'report_has_no_extra_options'               => 'Този отюет няма допълнителни опции',
    ...
    'budget'                                    => 'Бюджет',
    'spent'                                     => 'Похарчени',
    'spent_capped'                              => 'Похарчени (oграничени)',
    ...
    'table'                     => 'Таблица',
    'delete_piggy_bank'         => 'Изтрии касичка ":name"',
    ...
    'is (partially) refunded by_inward'     => 'е (частично) възтановено от',
    'is (partially) paid for by_inward'     => 'е (частично) платено от',
    'is (partially) reimbursed by_inward'   => 'е (частично) възтановено от',
    'inward_transaction'                    => 'Входяща транзакция',
    'outward_transaction'                   => 'Изходяща транзакция',
    'relates to_outward'                    => 'свързано с',
    '(partially) refunds_outward'           => '(частично) възтановява',
    '(partially) pays for_outward'          => '(частично) плаща за',
    '(partially) reimburses_outward'        => '(частично) възтановява',
    'is (partially) refunded by'            => 'е (частично) възтановено от',
    'is (partially) paid for by'            => 'е (частично) платено от',
    'is (partially) reimbursed by'          => 'е (частично) възтановено от',
    'relates to'                            => 'свързано с',
    '(partially) refunds'                   => '(частично) възтановява',
    '(partially) pays for'                  => '(частично) плаща за',
    '(partially) reimburses'                => '(частично) възтановява',
    ...
    'no_accounts_imperative_expense'        => 'Сметките за разходи се създават автоматично, когато създавате транзакции, но можете да създадете и ръчно, ако искате. Нека сега създадем такъва:',
    ...
    'no_accounts_imperative_revenue'        => 'Приходните сметки се създават автоматично, когато създавате транзакции, но можете да създадете и ръчно, ако искате. Нека сега създадем такъва:',
    ...
    'telemetry_delete_submitted_records' => 'Изтрии изпратените записи',
