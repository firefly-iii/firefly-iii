            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active">
                    <a href="{{ route('profile.index') }}#options" aria-controls="home" role="tab"
                       data-toggle="tab">{{ __('firefly.options') }}</a>
                </li>
                            ...
                            <form action="{{ route('profile.regenerate') }}" method="post">
                                <p>
                                    ...
                                    <button type="submit" class="btn btn-danger btn-xs"><span
                                                class="bi bi-arrow-repeat"></span> {{ 'regenerate_command_line_token'|_ }}
                                    </button>
                                </p>
                            </form>
                        </div>
                                ...
                                <p>
                                    <button type="button"
                                            ...
                                            data-type="purge" class="confirm btn btn-warning btn-sm"><span
                                                class="bi bi-trash"></span> {{ 'purge_all_data'|_ }}</button>
                                ...
                                <div class="btn-group">
                                    ...
                                    <button type="button"
                                            ...
                                            data-type="asset_accounts" class="confirm btn btn-danger btn-sm"><span
                                                class="bi bi-cash"></span> {{ 'delete_all_asset_accounts'|_ }}</button>
                                    ...
                                    <button type="button"
                                            ...
                                            data-type="revenue_accounts" class="confirm btn btn-danger btn-sm"><span
                                                class="bi bi-download"></span> {{ 'delete_all_revenue_accounts'|_ }}
                                    </button>
                                ...
                                <div class="btn-group">
                                    <button type="button"
                                            ...
                                            data-type="transactions" class="confirm btn btn-danger btn-sm"><span
                                                class="bi bi-arrow-left-right"></span> {{ 'delete_all_transactions'|_ }}
                                    </button>
