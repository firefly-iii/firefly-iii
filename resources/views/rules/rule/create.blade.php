...
@section('content')
    ...
    <form method="POST" action="{{ route('rules.store') }}" accept-charset="UTF-8" class="form-horizontal" id="store">
        ...
        <input type="hidden" name="return_to_bill" value="{% if returnToBill %}true@elsefalse@endif"/>
        <input type="hidden" name="bill_id" value="{% if bill %}{{ bill.id }}@else0@endif"/>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="box-body rule-trigger-box">
                        ...
                        <p>
                            <br/>
                            <button type="button" class="btn btn-outline-secondary add_rule_trigger">{{ 'add_rule_trigger'|_ }}</button>
                            <a href="#" class="btn btn-outline-secondary test_rule_triggers"><span class="fa fa-flask"></span> {{ 'test_rule_triggers'|_ }}</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn text-end btn-success">{{ 'store_new_rule'|_ }}</button>
                    </div>
                </div>
