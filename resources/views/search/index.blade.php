        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">{{ 'search_box'|_ }}</h3>
                </div>
                <div class="card-body">
                    <p>
                        {{ 'search_box_intro'|_ }}
                    ...
                    <form class="form-horizontal" action="{{ route('search.index') }}" method="get">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-1 col-sm-10">
                                ...
                                @endif
                                <a href="{{ route('rules.create') }}?from_query={{ fullQuery }}" class="btn btn-outline-secondary">{{ 'create_rule_from_query'|_ }}</a>
                            </div>
                        </div>
                        {% if 0 != ruleId %}
                        ...
                        <div class="row mass_edit_all hidden-xs hidden">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                <div class="mass_button_options btn-group btn-group hidden">
                                    <a href="#" class="btn btn-outline-secondary mass_edit"><span class="bi bi-pencil"></span> <span>{{ 'edit_selected'|_ }}</span></a>
                                    <a href="#" class="btn btn-outline-secondary bulk_edit"><span>{{ 'bulk_edit'|_ }}</span></a>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 hidden-xs">
                                ...
                                <div class="mass_buttons btn-group btn-group text-end">
                                    <a href="#" class="btn btn-outline-secondary mass_select"><span
                                            class="bi bi-check-square-o"></span> {{ 'select_transactions'|_ }}</a>
        ...
        <div class="row error_row hidden">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card card-danger card-outline">
                    <div class="card-header">
                        <h3 class="card-title">{{ 'search_error'|_ }}</h3>
                    </div>
                    <div class="card-body">
    ...
    {% if query|length == 0 and excludedWords|length == 0 and words|length == 0 and operators|length == 0 %}
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ 'search_results'|_ }}</h3>
                    </div>
                    <div class="card-body">
