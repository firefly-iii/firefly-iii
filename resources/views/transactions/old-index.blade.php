        ...
        <div class="@if(count($periods) > 0)col-lg-10 col-md-10 col-sm-12@elsecol-lg-12 col-md-12 col-sm-12@endif">
            <div class="card mb-2">
                ...
                <div class="card-body p-0">
                    <div class="p-2">
                        <a href="{{ route('transactions.create', [objectType]) }}" class="btn btn-success"><span class="bi bi-plus-circle"></span> {{ 'create_new_transaction'|_ }}</a>
                    </div>
                    {{-- actual list --}}
...
@section('scripts')
    ...
    <script type="text/javascript" nonce="{{ $JS_NONCE }}">
        var showAll = @if(count($periods) > 0)false@elsetrue@endif;
