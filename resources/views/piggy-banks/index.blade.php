                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover table-sm" id="accountStatus">
                            ...
                            <tr>
                                ...
                                <th class="text-end">{{ __('firefly.balance') }}</th>
                                <th class="text-end">{{ __('firefly.left_for_piggy_banks') }}</th>
                                <th class="text-end">{{ __('firefly.sum_of_piggy_banks') }}</th>
                                <th class="text-end">{{ __('firefly.saved_so_far') }}</th>
                                <th class="text-end">{{ __('firefly.left_to_save') }}</th>
                            </tr>
                            </thead>
                            <tbody>
...
@section('scripts')
    ...
    <script src="v1/js/lib/jquery-ui.min.js?v={{ $FF_BUILD_TIME }}" type="text/javascript" nonce="{{ $JS_NONCE }}"></script>
     <script src="v1/js/ff/piggy-banks/index.js?v={{ $FF_BUILD_TIME }}" nonce="{{ $JS_NONCE }}"></script>
@endsection
