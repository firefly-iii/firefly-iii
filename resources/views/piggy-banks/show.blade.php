    ...
    <div x-data="show">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="card_header_menu">
                                        <li><a class="dropdown-item"
                                               href="{{ route('piggy-banks.edit', $piggy['id']) }}?_from={{ urlencode($FF3_FROM) }}"><span
                                                    class="bi bi-pencil"></span> {{ __('firefly.edit') }}</a></li>
                                        <li><a class="dropdown-item"
                                               href="{{ route('piggy-banks.delete', $piggy['id']) }}?_from={{ urlencode($FF3_FROM) }}"><span
                ...
                <div class="card mb-2">
                    <div class="card-header">
                        <h3 class="card-title">{{ __('firefly.event_history') }}
                            <small>(<a @click.prevent="confirmHistoryRemoval"
                                class="confirm-history-delete reset-link" href="#">{{ __('firefly.reset_history') }}</a>)</small>
                        </h3>
                    </div>
...
@section('scripts')
    @vite(['js/pages/piggy-banks/show.js'])
    ...
    <script type="text/javascript" src="v1/js/ff/piggy-banks/show.js?v={{ $FF_BUILD_TIME }}"
            nonce="{{ $JS_NONCE }}"></script>
@endsection
