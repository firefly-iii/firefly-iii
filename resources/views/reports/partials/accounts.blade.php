<table class="table table-hover sortable">
    ...
    <tr>
        ...
        <th data-defaultsign="_19" class="text-end">{{ __('firefly.balanceStart') }}</th>
        <th data-defaultsign="_19" class="text-end">{{ __('firefly.balanceEnd') }}</th>
