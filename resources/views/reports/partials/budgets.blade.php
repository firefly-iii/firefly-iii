<table class="table table-hover sortable">
    ...
    <tr>
        ...
        <th data-defaultsign="_19"  class="text-end">{{ __('firefly.budgeted') }}</th>
        ...
        <th data-defaultsign="_19" class="text-end">{{ __('firefly.left') }}</th>
    ...
    @foreach($report['budgets'] as $budget)
        @foreach($budget['budget_limits'] as $budgetLimit)
            <tr>
                ...
                <td data-value="{{ $budgetLimit['budgeted'] }}" class="text-end">
                ...
                <td data-value="{{ $budgetLimit['left'] }}" class="text-end">
