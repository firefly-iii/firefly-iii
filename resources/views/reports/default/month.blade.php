  ...
  <span class="visually-hidden">{{ __('firefly.thinking') }}</span>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card mb-2">
                <div class="card-header">
                    <h3 class="card-title">{{ __('firefly.budgets') }} ({{ strtolower(__('firefly.splitByAccount')) }})</h3>
                </div>
  ...
  <span class="visually-hidden">{{ __('firefly.thinking') }}</span>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card mb-2">
                <div class="card-header">
                    <h3 class="card-title">{{ __('firefly.bills') }}</h3>
                </div>
...
@section('scripts')
    @vite(['js/pages/generic.js'])
     ...
     <script src="v1/js/ff/reports/default/month.js?v={{ $FF_BUILD_TIME }}" nonce="{{ $JS_NONCE }}"></script>
@endsection
