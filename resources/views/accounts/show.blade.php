                        ...
                        <div class="col text-end">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="card_header_menu">
                                        <li><a class="dropdown-item" href="{{ route('accounts.edit', [$account->id]) }}?_from={{ urlencode('/accounts/show/' . $account->id) }}"><span
                                                    class="bi bi-pencil"></span> {{ __('firefly.edit') }}</a></li>
                                        <li><a class="dropdown-item" href="{{ route('accounts.delete', [$account->id]) }}?_from={{ urlencode('/accounts/show/' . $account->id) }}"><span
