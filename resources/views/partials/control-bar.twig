            ...
            <ul class='control-sidebar-menu'>
                <li>
                    <a href="{{ route('transactions.create', 'withdrawal') }}">
                        <span class="menu-icon bi bi-arrow-left bg-red"></span>
                ...
                <li>
                    <a href="{{ route('transactions.create', 'deposit') }}">
                        <span class="menu-icon bi bi-arrow-right bg-green"></span>
                ...
                <li>
                    <a href="{{ route('transactions.create', 'transfer') }}">
                        <span class="menu-icon bi bi-arrow-left-right bg-blue"></span>
                ...
                <li>
                    <a href="{{ route('accounts.create', 'asset') }}">
                        <span class="menu-icon bi bi-cash bg-maroon"></span>
                ...
                <li>
                    <a href="{{ route('accounts.create', 'revenue') }}">
                        <span class="menu-icon bi bi-download bg-maroon"></span>
                ...
                <li>
                    <a href="{{ route('budgets.create') }}">
                        <span class="menu-icon bi bi-pie-chart bg-red"></span>
                ...
                <li>
                    <a href="{{ route('categories.create') }}">
                        <span class="menu-icon bi bi-bookmark bg-red"></span>
                ...
                <li>
                    <a href="{{ route('subscriptions.create') }}">
                        <span class="menu-icon bi bi-calendar-o bg-purple"></span>
