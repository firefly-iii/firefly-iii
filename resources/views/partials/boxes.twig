<div class="row hidden-xs">
        ...
        <div class="info-box bg-aqua-gradient" id="box_out_holder">
            ...
            <div class="info-box-content">
                <span class="info-box-text">
                    <a href="{{ route('reports.report.default', ['allAssetAccounts',start.format('Ymd'),end.format('Ymd')]) }}">{{ 'in_out_period'|_ }}</a></span>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="info-box bg-teal-gradient">
            <span class="info-box-icon"><span class="bi bi-calendar-o"></span></span>
    ...
    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="info-box bg-green-gradient" id="box-left-to-spend-box">
            <span class="info-box-icon"><span class="bi bi-cash"></span></span>
            <div class="info-box-content">
